...
@interface ReceiveControl : NSObject <NSWindowDelegate, NSTableViewDataSource, NSTableViewDelegate, NSMenuItemValidation>

@property(strong)	IBOutlet NSWindow*				window;						// ウィンドウ
...
@property(strong)	IBOutlet NSPanel*				pwdSheet;					// パスワード入力パネル（シート）
...
@property(strong)	IBOutlet NSPanel*				attachSheet;				// ダウンロードシート
